    ...
    return (
        <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                />
                <motion.div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-yellow-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"
                    animate={floatingAnimation}
            ...
            >
                <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 sm:p-8 border border-slate-700/50 transform transition-all duration-300 hover:shadow-purple-500/10">
                    ...
                    {/* Error Message */}
                    <AnimatePresence>
                        {(formik.errors.submit || formik.errors.username || formik.errors.password) && (
                            <motion.div
                            ...
                            >
                                <div className="flex items-center gap-2 text-red-400 text-sm">
                                    ...
                                    <span>{formik.errors.submit || formik.errors.username || formik.errors.password}</span>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-5">
                        ...
                        <motion.div variants={itemVariants} className="flex items-center justify-between">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                <input
                                    ...
                                    onChange={formik.handleChange}
                                    className="w-4 h-4 rounded border-slate-600 bg-slate-700 text-purple-500 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer"
                                />
                        ...
                        <motion.div variants={itemVariants}>
                            <button
                                type="submit"
                                disabled={loading}
                                className="relative w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-lg font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 disabled:opacity-50 disabled:hover:scale-100 overflow-hidden group"
                            >
                    ...
                    <motion.div variants={itemVariants} className="mt-8 p-4 bg-slate-700/30 rounded-lg border border-slate-600/30">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="px-3 py-2 bg-slate-700 hover:bg-slate-600 rounded-lg text-sm text-white transition-all duration-200 hover:scale-105 flex items-center justify-center gap-2"
                            >
                                <Crown className="w-4 h-4 text-yellow-400" />
                                Admin Demo
                            </button>
                    ...
                    <motion.div variants={itemVariants} className="mt-6 text-center">
                        <p className="text-slate-400 text-sm">
                            ...
                            <Link to="/register" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors inline-flex items-center gap-1 group">
                                Create account
